...
const YearlyResult = sequelize.define(
  "yearly_results",
  {
    ...
    trainingRating: { type: DataTypes.STRING, allowNull: true },
    partyRating: { type: DataTypes.STRING, allowNull: true },
    partyRatingDecisionNumber: { type: DataTypes.STRING, allowNull: true },
